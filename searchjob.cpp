    ...
    ui(new Ui::searchjob)
{
    ...
    ui->label_test->setText("Click on the Job id to apply");
...
void searchjob::on_pushButton_apply_clicked()
{
    ...
    if(alreadyApplied(jobid, username)){
            QMessageBox::information(this,tr("Apply"),tr("Already Applied"));
            return;
    ...
    if(qryapply.exec())
    {
    QMessageBox::information(this,tr("Apply"),tr("Applied Successfully"));
